...
export const SECTOR_MAP: Record<string, SectorInfo> = {
  ...
  VAMO3: { sector: 'Logística', color: '#5ab0a0', icon: '🚛' },
  RENT3: { sector: 'Logística', color: '#5ab0a0', icon: '🚛' },
  // Energia e Petróleo
  PETR4: { sector: 'Petróleo', color: '#5ab0a0', icon: '🛢️' },
  PETR3: { sector: 'Petróleo', color: '#5ab0a0', icon: '🛢️' },
  PRIO3: { sector: 'Petróleo', color: '#5ab0a0', icon: '🛢️' },
  RECV3: { sector: 'Petróleo', color: '#5ab0a0', icon: '🛢️' },
  RRRP3: { sector: 'Petróleo', color: '#5ab0a0', icon: '🛢️' },
  ...
  CCRO3: { sector: 'Logística', color: '#5ab0a0', icon: '🚛' },
  ECOR3: { sector: 'Logística', color: '#5ab0a0', icon: '🚛' },
