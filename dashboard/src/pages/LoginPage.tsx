    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{
          ...
          {error && (
            <div style={{
              display: 'flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(224,112,112,0.1)',
              border: '1px solid rgba(224,112,112,0.3)', borderRadius: 8, padding: '0.75rem 1rem',
              marginBottom: '1rem', color: '#e89090', fontSize: '0.85rem',
            }}>
