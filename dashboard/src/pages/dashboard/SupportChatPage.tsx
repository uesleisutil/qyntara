            ...
            return (
              <div key={m.id} style={{ display: 'flex', justifyContent: isUser ? 'flex-end' : 'flex-start' }}>
                <div style={{
                  ...
                  background: isUser ? 'linear-gradient(135deg, #2563eb, #3b82f6)' : (darkMode ? '#2a2e3a' : '#f1f2f6'),
          ...
          <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.5rem' }}>
            ...
            <button onClick={handleSend} disabled={sending || !message.trim()}
              style={{
                ...
                background: message.trim() ? 'linear-gradient(135deg, #2563eb, #3b82f6)' : (darkMode ? '#2a2e3a' : '#e0e2e8'),
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          <textarea value={message} onChange={e => setMessage(e.target.value)} onKeyDown={handleKeyDown}
            ...
            style={{
              ...
              border: `1px solid ${theme.border}`, background: darkMode ? '#0f1117' : '#f8f9fb',
