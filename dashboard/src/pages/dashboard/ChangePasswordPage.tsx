...
const ChangePasswordPage: React.FC = () => {
  ...
  const inputStyle: React.CSSProperties = {
    ...
    background: darkMode ? '#0f172a' : '#f8fafc', border: `1px solid ${theme.border}`,
  ...
  return (
    <div>
      <div style={{ marginBottom: '1.5rem' }}>
        <h1 style={{ fontSize: '1.5rem', fontWeight: 700, color: theme.text, marginBottom: '0.25rem' }}>Alterar Senha</h1>
      ...
      <div style={cardStyle}>
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '1.25rem', padding: '0.75rem', borderRadius: 8, background: darkMode ? '#0f172a' : '#f8fafc', border: `1px solid ${theme.border}` }}>
          ...
          <button type="submit" disabled={!allValid || loading} style={{
            ...
            background: allValid && !loading ? 'linear-gradient(135deg, #2563eb, #3b82f6)' : (darkMode ? '#334155' : '#e2e8f0'),
