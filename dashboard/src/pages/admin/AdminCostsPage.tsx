...
const AdminCostsPage: React.FC = () => {
  ...
  const kpis = [
    ...
    { label: 'Custo 7 dias (USD)', value: fmt(total7d.usd) ? `$${fmt(total7d.usd)}` : '—', color: '#3b82f6', icon: <TrendingDown size={16} />, tip: 'Custo total acumulado dos últimos 7 dias em dólares.' },
    ...
    <div>
      ...
      {threshold.limit_brl && (
        <div style={{ ...cardStyle, marginBottom: '1.25rem' }}>
          ...
          <div style={{ height: 12, borderRadius: 6, background: darkMode ? '#334155' : '#e2e8f0' }}>
