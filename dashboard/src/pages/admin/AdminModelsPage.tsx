...
const AdminModelsPage: React.FC = () => {
  ...
  function renderPipeline() {
    const pipelines = [
      ...
      {
        name: 'WeeklyRetrain (SageMaker)', description: 'Retreina ensemble DL via SageMaker Training Jobs (ml.m5.xlarge, 16GB RAM). Cada modelo treina em paralelo sem limite de tempo, depois combina na Lambda.',
        ...
        outputs: [
          ...
          'models/deep_learning/{date}/model.tar.gz (ensemble combinado na Lambda)',
        ],
