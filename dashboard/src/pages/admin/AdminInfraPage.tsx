          ...
          <div style={{ fontSize: '0.75rem', color: theme.textSecondary, lineHeight: 1.8, fontFamily: 'monospace' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(220px, 100%), 1fr))', gap: '1rem' }}>
              {[
                ...
                { title: '🧠 DL Pipeline', items: ['PrepareTrainingData → S3', 'WeeklyRetrain → Ensemble DL (3 modelos)', 'RankSageMaker → S3 recommendations/', 'GenerateEnsembleInsights', 'GenerateFeatureImportance', 'GeneratePredictionIntervals'] },
