...
const AdminNotificationsPage: React.FC = () => {
  ...
  const inputStyle: React.CSSProperties = {
    width: '100%', padding: '0.6rem 0.75rem', backgroundColor: darkMode ? '#0f1117' : '#f8fafc',
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 150 }}>
          ...
          <div style={{ display: 'flex', gap: '0.4rem', marginTop: 4, flexWrap: 'wrap' }}>
            ...
            <span style={{ fontSize: '0.65rem', padding: '0.1rem 0.4rem', borderRadius: 4, background: darkMode ? '#2a2e3a' : '#f1f5f9', color: theme.textSecondary }}>
      ...
      <div style={{ ...cardStyle, marginTop: '1.25rem', borderLeft: '4px solid #25d366' }}>
        ...
        <button
          ...
          style={{
            ...
            background: whatsappMsg.trim() && !whatsappSending ? 'linear-gradient(135deg, #25d366, #128c7e)' : (darkMode ? '#2a2e3a' : '#e2e8f0'),
