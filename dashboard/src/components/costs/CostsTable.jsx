        ...
        <table style={{ 
          ...
          <thead>
            <tr style={{ backgroundColor: '#f8fafc', borderBottom: '2px solid #e2e8f0' }}>
              <th style={{ padding: '0.75rem', textAlign: 'left', fontWeight: '600', color: '#1e293b' }}>
                Componente
              </th>
              <th style={{ padding: '0.75rem', textAlign: 'right', fontWeight: '600', color: '#1e293b' }}>
                Total (7 dias)
              </th>
              <th style={{ padding: '0.75rem', textAlign: 'right', fontWeight: '600', color: '#1e293b' }}>
                Média Diária
              ...
              <th style={{ padding: '0.75rem', textAlign: 'center', fontWeight: '600', color: '#1e293b' }}>
                Tendência
              </th>
            </tr>
          </thead>
          <tbody>
            {tableData.map((row, idx) => {
              ...
              return (
                ...
                >
                  <td style={{ padding: '0.75rem', fontWeight: '500', color: '#1e293b' }}>
                    {row.component}
                  </td>
