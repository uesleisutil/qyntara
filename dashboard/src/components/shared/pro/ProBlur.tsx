      ...
      <div style={{
        ...
        <div style={{
          ...
          <button onClick={close} style={{
            ...
            color: darkMode ? '#64748b' : '#6b7280', cursor: 'pointer', padding: 2,
          }} aria-label="Fechar">
            <X size={16} />
          </button>
          <Lock size={24} color="#f59e0b" style={{ marginBottom: 8 }} />
          <div style={{ fontSize: '0.9rem', fontWeight: 700, color: darkMode ? '#f1f5f9' : '#0f1117', marginBottom: 4 }}>
            {label}
          </div>
          <div style={{ fontSize: '0.75rem', color: darkMode ? '#9ba1b0' : '#64748b', lineHeight: 1.5, marginBottom: 12 }}>
