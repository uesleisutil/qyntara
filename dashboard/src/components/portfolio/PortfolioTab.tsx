...
const pieColors = ['#3b82f6', '#10b981', '#f59e0b', '#3b82f6', '#ef4444', '#06b6d4', '#ec4899', '#84cc16'];
                  ...
                  <tr style={{ borderBottom: `1px solid ${theme.border}` }}>
                    {[
                      ...
                      <th key={h.l} style={{
                        ...
                        color: theme.textSecondary, background: darkMode ? '#0f1117' : '#f8fafc', whiteSpace: 'nowrap',
                      }}>
                  ...
                  {portfolio.map((q, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td style={{ padding: '0.5rem 0.45rem' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                            <div style={{ flex: 1, height: 5, borderRadius: 3, background: darkMode ? '#2a2e3a' : '#e2e8f0', maxWidth: 50, overflow: 'hidden' }}>
