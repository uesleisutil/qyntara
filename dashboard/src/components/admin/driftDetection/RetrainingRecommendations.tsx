      ...
      <div style={cardStyle}>
        <div style={{ padding: '1rem', borderBottom: `1px solid ${theme.border}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: 'pointer' }}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
            ...
            <span style={{ fontSize: '0.72rem', color: theme.textSecondary, background: darkMode ? '#2a2e3a' : '#f1f5f9', padding: '0.1rem 0.45rem', borderRadius: 10 }}>{completedItems} / {totalItems}</span>
          </div>
        ...
        <div style={{ height: 4, background: darkMode ? '#2a2e3a' : '#e2e8f0', position: 'relative' }}>
        ...
        {showChecklist && (
          <div style={{ padding: '1rem' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
              {checklist.map((item, idx) => (
                <div key={idx} onClick={() => toggleChecklistItem(idx)} style={{
                  ...
                  background: darkMode ? '#0f1117' : '#f8fafc', borderRadius: 8, cursor: 'pointer',
            ...
            <div style={{ marginTop: '0.75rem', padding: '0.65rem', background: darkMode ? '#0f1117' : '#f8fafc', borderRadius: 8, fontSize: '0.72rem', color: theme.textSecondary, lineHeight: 1.5 }}>
