                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                  <div style={{
                    ...
                    <p style={{ 
                      ...
                      fontWeight: 'bold', 
                      margin: 0,
                      color: (ticker.confidence_score || ticker.score || 0) === bestScore ? '#10b981' : '#1e293b'
                    }}>
                  ...
                  <div style={{
                    ...
                    <p style={{ 
                      ...
                      color: ((ticker.expected_return || ticker.exp_return_20 || 0) * 100) === bestReturn ? '#10b981' : 
                             ((ticker.expected_return || ticker.exp_return_20 || 0) >= 0 ? '#1e293b' : '#ef4444')
                    }}>
                  ...
                  <div style={{
                    ...
                    <p style={{ fontSize: '0.875rem', fontWeight: '500', margin: 0, color: '#1e293b' }}>
                      {ticker.sector || '-'}
                    </p>
                  </div>
                </div>
                  ...
                  <tr>
                    ...
                    {metrics.map((m, idx) => (
                      <td key={idx} style={{ 
                        ...
                        fontSize: '0.875rem',
                        fontWeight: '600',
                        color: m.score === bestScore ? '#10b981' : '#1e293b',
                  ...
                  <tr>
                    ...
                    {metrics.map((m, idx) => (
                      <td key={idx} style={{ 
                        ...
                        fontSize: '0.875rem',
                        fontWeight: '600',
                        color: m.expectedReturn === bestReturn ? '#10b981' : (m.expectedReturn >= 0 ? '#1e293b' : '#ef4444'),
