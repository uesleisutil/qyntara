...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    from ml.src.features.fundamental_features import fetch_fundamentals_brapi, save_fundamentals_to_s3
    from ml.src.features.macro_features import fetch_all_macro_data, calculate_macro_features, save_macro_to_s3
